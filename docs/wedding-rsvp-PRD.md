...
**Owner:** Dmitri
**Status:** v6 — greenfield spec, the source of truth for what gets built.
**Date:** 2026-07-30
...
**Search** by name or phone. **Sort** by relation (default — family, friends, work, invited-by-family, in that fixed staged order), name, status, headcount, or last-contacted. **Filter** by all five statuses.
